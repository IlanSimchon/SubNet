...
class ApartmentManager {
    constructor() {
        ...
        // this.apartmentBoxx = document.getElementById("apartment-box");
        ...
        // this.apartmentBoxx.addEventListener('click', this.displaySingleApartment.bind(this));
            ...
            if (apartments.length > 0) {
                ...
                apartments.forEach(apartment => {
                    ...
                    apartmentBox.addEventListener('click', () => {
                        ...
                        this.displaySingleApartment(apartmentId); // Use "this" to refer to the current instance of ApartmentManager
                    });
                });
